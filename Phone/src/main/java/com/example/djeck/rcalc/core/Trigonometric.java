...
public class Trigonometric implements OperatorSet {
    ...
    public Trigonometric(TextView textView) {
        mTextView = textView;
    }
    ...
    public Double compute(String operation, ArrayList<Double> args) {
        if(args.size()<getArgumentsNumber(operation)) {
            ...
            mTextView.setText("ERROR: In trigonometric librairy there is no function "+operation);
            return Double.NaN;
        }
    }
    ...
    public void help(String operation) {
        if(operation.equals("cos")) {
            mTextView.setText("Cosinus of two numbers\n");
            mTextView.append("ex: pi cos returns -1");
        }
        else if(operation.equals("sin")) {
            mTextView.setText("Sinus of two numbers\n");
            mTextView.append("ex: pi/2 cos returns 1");
        }
    }
